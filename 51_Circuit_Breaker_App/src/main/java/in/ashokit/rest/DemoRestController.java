...
public class DemoRestController {
	...
	@GetMapping("/data")
	@CircuitBreaker(fallbackMethod = "getDataFromDB", name = "ashokit")// "name" property for circuitbreaker name .which is mandatory.
...
//		int i = 10/0;
	...
	public String getDataFromDB(Throwable t) {// focus on parameter
